...
execute(message,args,client) {
    ...
    .setDescription(`**✅ | ${message.author} shuffled the Queue**`,"https://hotemoji.com/images/dl/4/shuffle-tracks-button-emoji-by-twitter.png")
    .setColor("#ffe700")).catch(console.error);
  }
};
